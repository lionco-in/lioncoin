...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " lioncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  lioncoin-tx [options] <hex-tx> [commands]  Update hex-encoded lioncoin transaction\n" +
            "or:     lioncoin-tx [options] -create [commands]   Create hex-encoded lioncoin transaction\n" +
            "\n";
