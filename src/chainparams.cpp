...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.lioncoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.lioncointools.com");
        vSeeds.emplace_back("dnsseed.lioncoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.lioncointools.com");
        vSeeds.emplace_back("seed-b.lioncoin.loshan.co.uk");
