...
#if defined(NDEBUG)
# error "Lioncoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Lioncoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
...

    {
        ...
        for (CTxMemPool::txiter it : allConflicting)
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LION additional fees, %d delta bytes\n",
