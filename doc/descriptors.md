# Support for Output Descriptors in Lioncoin Core

Since Lioncoin Core v0.17, there is support for Output Descriptors. This is a
...
on Lioncoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Lioncoin Core wallets, a convenience function `combo` is
