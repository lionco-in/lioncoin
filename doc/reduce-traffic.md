...
By default, Lioncoin Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that lioncoin's trustless model works best if you are
